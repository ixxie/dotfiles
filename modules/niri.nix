    ...
    programs = {
      niri = {
        ...
        settings = {
          ...
          layout = {
            gaps = 8;
            preset-column-widths = map (n: {proportion = n / 8.0;}) (lib.range 1 8);
          ...
          binds = with config.lib.niri.actions;
            vimAliases {
              ...
              # janeway overlay
              "Mod+K".action.spawn = ["jw" "toggle"];
              # fn
              "XF86AudioLowerVolume".action.spawn = ["cyberdeck" "audio" "down"];
              "XF86AudioRaiseVolume".action.spawn = ["cyberdeck" "audio" "up"];
              "XF86AudioMute".action.spawn = ["cyberdeck" "audio" "mute"];
